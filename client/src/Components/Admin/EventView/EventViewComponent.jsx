        ...
        <div className="h-screen overflow-y-auto scrollbar-thin scrollbar-thumb-green-400 scrollbar-slate-700">
            ...
            <div className="p-5">
                <div className="p-8 bg-white shadow">
                    <div className="mt-5 text-center pb-5">
                        {state ? (
                            <>
                                ...
                                <p className="mt-8 text-gray-500">Contact - {ground?.phone}</p>
                    ...
                    <div className="">
                        <div className="flex flex-wrap justify-center items-center border-b pb-10">
                            {rows &&
                                rows?.map((res) => {
                                    return (
                                        <>
                                    ...
                                    return (
                                        <>
                                            <marquee behavior="alternate" direction="left">
                                                <div className="">
                                                    <img src={res} className="w-44 h-52 m-2" alt="Event-photo" />
                                                </div>
                                            </marquee>
                                        </>
                                    );
