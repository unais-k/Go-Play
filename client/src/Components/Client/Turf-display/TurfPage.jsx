...
function TurfPage() {
  ...
  const handleSearch = async (e) => {
    ...
    const response = await SearchGroundReqApi(searchValue);
  };
  return (
          ...
          <div className="listing w-full">
            <div className="search-bar justify-center items-center flex flex-col pt-3">
              <p className="text-lime-600 text-sm font-bold">
                Search for the best turf grounds, indoor courts grounds in your
                city
              </p>
            ...
            <div>
              <h1 className="text-4xl font-bold text-lime-600 text-left mt-5 mb-3">
                Football
              </h1>
            </div>
