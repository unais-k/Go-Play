...
function ReviewComponent() {
    return (
        <div>
            <div className="text-2xl font-bold text-lime-600 my-10">Reviews</div>
            <article>
                ...
                <p class="mb-2 text-gray-500 dark:text-gray-400">
                    ...
                    and the first thing I did was set the time, popped on an identical strap from another Invicta and went
