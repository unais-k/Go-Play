...
const Sidebar = () => {
  ...
  const Menus = [
    ...
    { title: 'Review', path: "/turf-admin/", src: <MdOutlineRateReview /> },
    { title: 'Profile', path: "/turf-admin/profile", src: <CgProfile /> },
    { title: 'Logout', path: "/turf-admin/logout", src: <GrLogout />, },
  ]
      ...
      >
        ...
        <Link to='/'>
          <div className={`flex ${open && 'gap-x-4'} items-center`}>
            ...
            {open && (
              <span className='text-xl font-admin whitespace-nowrap dark:text-white'>
              Go-Play
              </span>
            )}
          </div>
